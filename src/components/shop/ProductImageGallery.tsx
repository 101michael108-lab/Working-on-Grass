      ...
      <Dialog open={fullscreenOpen} onOpenChange={setFullscreenOpen}>
        <DialogContent className="max-w-[90vw] h-[90vh] p-4 bg-transparent border-none shadow-none flex items-center justify-center">
          ...
          <Carousel className="w-full max-w-6xl h-full" setApi={setFullscreenApi} opts={{ startIndex: selectedIndex, loop: true }}>
            ...
            <CarouselPrevious className="absolute left-2 text-white bg-black/50 hover:bg-black/80 hover:text-white border-none h-10 w-10"/>
            <CarouselNext className="absolute right-2 text-white bg-black/50 hover:bg-black/80 hover:text-white border-none h-10 w-10" />
          </Carousel>
        </DialogContent>
      </Dialog>
    </div>
